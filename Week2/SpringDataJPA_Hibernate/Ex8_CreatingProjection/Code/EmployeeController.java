...
public class EmployeeController {
    ...
    public Page<Employee> searchEmployeesPaginated(
        ...
        Sort sort = dir.equalsIgnoreCase("desc") ? Sort.by(sortBy).descending() : Sort.by(sortBy).ascending();
        Pageable pageable = PageRequest.of(page, size, sort);
        return employeeRepository.searchByNameKeyword(keyword, pageable);
    }
    ...
    @GetMapping("/department/{deptId}/projection/closed")
    public List<EmployeeProjection> getClosedProjection(@PathVariable Long deptId) {
        return employeeRepository.findProjectedByDepartmentId(deptId);
    }

    @GetMapping("/department/{deptId}/projection/open")
    public List<EmployeeDetailedProjection> getOpenProjection(@PathVariable Long deptId) {
        return employeeRepository.findDetailedProjectedByDepartmentId(deptId);
    }

    @GetMapping("/department/{deptId}/projection/dto")
    public List<EmployeeDto> getDtoProjection(@PathVariable Long deptId) {
        return employeeRepository.findEmployeeDtoByDepartmentId(deptId);
    }
}
