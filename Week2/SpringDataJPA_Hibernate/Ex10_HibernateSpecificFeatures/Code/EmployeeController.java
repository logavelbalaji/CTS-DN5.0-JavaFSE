...
public class EmployeeController {
    ...
    @PostMapping("/batch")
    public ResponseEntity<String> saveEmployeesBatch(@RequestBody List<Employee> employees) {
        ...
        return ResponseEntity.ok("Successfully batch inserted " + employees.size() + " employees.");
    }

    @GetMapping("/all-including-deleted")
    public List<Employee> getAllIncludingDeleted() {
        return employeeRepository.findAllIncludingDeleted();
    }
}
